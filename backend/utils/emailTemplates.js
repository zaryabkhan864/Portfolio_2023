...
<body>
    <span class="preheader">Use this link to reset your password. The link is only valid for 30
        minutes.</span>
                ...
                <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                        <td class="email-masthead">
                            <a href="https://shopit.com" class="f-fallback email-masthead_name">
                                ShopIT
                            </a>
                        </td>
                    </tr>
                                    ...
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <p>
                                                ...
                                                <strong>This password reset is only valid for the next 30
                                                    minutes.</strong>
                                            </p>
